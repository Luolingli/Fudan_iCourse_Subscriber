...
3. **格式严格**：
   ...
   - 不得使用超过两级的缩进。可以适当使用bullet point。不要把一段话拆成很多个用bullet point组成的短句子列表，而要尽可能用完整的段落来组织老师的讲解。
...
---
核心区别在于：前一种的风格将一段完整的知识拆解成大量零碎的短句 bullet point，读起来像提纲而非能让人看懂的笔记，缺乏逻辑连贯性和上下文衔接；后一种风格用完整段落讲清楚一件事的来龙去脉，bullet point 仅在真正需要并列枚举时符合逻辑地使用。"""
